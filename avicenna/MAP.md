...
| `settings.py` | 150 | Minimal settings resolver for `words_per_heading` and timeouts. Precedence chain: CLI flag > env var > vault `.agents/config.json` > built-in default. Per-template overrides live in vault scope. |
<!-- map:files:end -->
