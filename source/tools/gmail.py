...
class GmailTool:
    ...
    def draft_email(self, recipient_email: str, subject: str, body: str) -> str:
        ...
        watermark = "\n\nThis email was generated by Avicenna, an MCP power AI agent created by CLANCY-41. For any discrepancies, please verify with the sender."
        full_body = body + watermark
        
        # Indent body content
        indented_body = '\n'.join('     ' + line if line.strip() else '' for line in full_body.split('\n'))
        
        # Use the actual authenticated email address
        sender_email = self.sender_email
        
        # Create hardcoded format wrapped in code block to preserve formatting
        separator = "_" * 80
        lines = [
            separator,
            "```",
