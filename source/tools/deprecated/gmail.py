...
class GmailTool:
    ...
    def draft_email(self, recipient_email: str, subject: str, body: str) -> str:
        ...
        watermark = "\n\n    This email was generated by Avicenna, an MCP-powered AI agent created by CLANCY-41."
        
        # Indent body content
        indented_body = '\n'.join('    ' + line if line.strip() else '' for line in body.split('\n'))
        full_body_with_watermark = indented_body + watermark
        
        # Use the actual authenticated email address
        sender_email = self.sender_email
        
        # Create simple format with underscores and bold keywords
        separator = "_" * 80
